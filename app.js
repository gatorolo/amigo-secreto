...
function agregarAmigo() {
  ...
  if (/\d/.test(nombre.value) || nombre.value.trim() === "") { // Verifica si el nombre ingresado contiene un número usando una expresión regular.
    ...
    document.getElementById("mensaje").textContent = " Ese amigo ya estä Participando"; // Muestra mensaje de duplicado.
